    ...
    <nav>
        <ul class="menu">
            ...
            <li class="item"><a href="#whatis"><?php if(!empty($user)): ?>
                     Welcome:  <?= $user['name']; ?>   <?php endif; ?></a></li>

            <li class="item"><p>Select lenguage:</p></li>
            ...
            <li class="item"><a href="index.php#Inicio">Home</a></li>
            <li class="item"><a href="index.php#opiniones">Opinions</a></li>
            <li class="item"><a href="index.php#productos">Products</a></li>

            <?php if(!empty($results)&&($results['type']==1 && !empty($user))): ?>
                <li class="item"><a href="editaren.php">Edit</a></li>
            ...
            <?php if(!empty($user) ): ?>
                        <li class="item button secondary"><a href="cerrarprueba.php">Logout</a></li>
                        <?php else :?>
                            <li class="item button"><a href="inicioprueba.php">Login</a></li>
                        <?php endif; ?>	
